...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------DimsGanz'+'AnkerGanz';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'apifree') return res.json(loghandler.invalidKey)
...
router.get('/textmaker/new', async (req, res, next) => {
        var theme = req.query.theme,
             text = req.query.text,
             text2 = req.query.text2,
             text3 = req.query.text3,
	...
	if(apikeyInput != 'apifree') return res.json(loghandler.invalidKey)
        if (!theme) return res.json(loghandler.nottheme)
        if (theme != 'smoke' && theme != 'romance') return res.json(loghandler.notheme)
        if (!text) return res.json(loghandler.nottext)
...
router.get('/textmaker/new2', async (req, res, next) => {
	...
	if(apikeyInput != 'apifree') return res.json(loghandler.invalidKey)
        if (!theme) return res.json(loghandler.nottheme)
        if (theme != 'shadow' && theme != 'naruto') return res.json(loghandler.notheme)
        if (!text) return res.json(loghandler.nottext)
...
router.get('/textmaker/new3', async (req, res, next) => {
	...
	if(apikeyInput != 'apifree') return res.json(loghandler.invalidKey)
        if (!theme) return res.json(loghandler.nottheme)
        if (theme != 'love' && theme != 'undergrass') return res.json(loghandler.notheme)
        if (!text) return res.json(loghandler.nottext)
...
router.get('/textmaker/new4', async (req, res, next) => {
        var theme = req.query.theme,
             text = req.query.text,
             text2 = req.query.text2,
             text3 = req.query.text3,
	...
	if(apikeyInput != 'apifree') return res.json(loghandler.invalidKey)
        if (!theme) return res.json(loghandler.nottheme)
        if (theme != 'rainbowshine' && theme != 'graffiti') return res.json(loghandler.notheme)
        if (!text) return res.json(loghandler.nottext)

        if (theme == 'rainbowshine') {
            try {
            request.post({
                url: "https://photooxy.com/logo-and-text-effects/rainbow-shine-text-223.html",
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                },
                body: `text_1=${text}&login=OK`,
...
router.get('/textmaker/new5', async (req, res, next) => {
        var theme = req.query.theme,
             text = req.query.text,
             text2 = req.query.text2,
             text3 = req.query.text3,
	...
	if(apikeyInput != 'apifree') return res.json(loghandler.invalidKey)
        if (!theme) return res.json(loghandler.nottheme)
        if (theme != 'makingcandy' && theme != 'glowrainbow') return res.json(loghandler.notheme)
        if (!text) return res.json(loghandler.nottext)

        if (theme == 'makingcandy') {
            try {
            request.post({
                url: "https://photooxy.com/logo-and-text-effects/honey-text-effect-218.html",
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                },
                body: `text_1=${text}&login=OK`,
...
router.get('/textmaker/new6', async (req, res, next) => {
        var theme = req.query.theme,
             text = req.query.text,
             text2 = req.query.text2,
             text3 = req.query.text3,
	...
	if(apikeyInput != 'apifree') return res.json(loghandler.invalidKey)
        if (!theme) return res.json(loghandler.nottheme)
        if (theme != 'flaming' && theme != 'metalic') return res.json(loghandler.notheme)
        if (!text) return res.json(loghandler.nottext)
...
router.get('/textmaker/new7', async (req, res, next) => {
        var theme = req.query.theme,
             text = req.query.text,
             text2 = req.query.text2,
             text3 = req.query.text3,
...
router.get('/textmaker/new9', async (req, res, next) => {
	...
	if(apikeyInput != 'apifree') return res.json(loghandler.invalidKey)
        if (!theme) return res.json(loghandler.nottheme)
        if (theme != 'woodblock' && theme != 'partyneon') return res.json(loghandler.notheme)
        if (!text) return res.json(loghandler.nottext)
...
router.get('/textmaker/new10', async (req, res, next) => {
        var theme = req.query.theme,
             text = req.query.text,
             text2 = req.query.text2,
             text3 = req.query.text3,
	...
	if(apikeyInput != 'apifree') return res.json(loghandler.invalidKey)
        if (!theme) return res.json(loghandler.nottheme)
        if (theme != 'skionline' && theme != '3d') return res.json(loghandler.notheme)
        if (!text) return res.json(loghandler.nottext)
